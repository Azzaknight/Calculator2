//
//  GraphFavouritesViewController.m
//  Calculator2
//
...
@interface GraphFavouritesViewController ()

@end

@implementation GraphFavouritesViewController
...
// delete the number of sections as we want the default
...
{
    id program = [self.programs objectAtIndex:indexPath.row];
    [self.delegate graphFavouritesViewController:self choseProgram:program];
